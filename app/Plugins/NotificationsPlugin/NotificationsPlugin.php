...
class NotificationsPlugin extends PluginAbstract
{
	...
	public function hooks()
	{
		...
		Plugin::add_hook('admin_notification', function($notification){
			$notificationContent = NotificationContent::find($notification->entity_id);			
			return Theme::view('plugin.NotificationsPlugin.admin_notif_item', ["content" => $notificationContent->content]);
