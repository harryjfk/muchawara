		...
		Theme::hook('main_menu',function() {
			...
			return array(
				array(
					...
					"url" => $url,
					"attributes" => array(
//						"class" => "material-icons pull-left material-icon-custom-styling sidebar-icons"
						"class" => "material-icons pull-left sidebar-icons"
					),
                    "url_img" => asset('themes/DefaultTheme/images/hook.png'),
				),
				array(
                    ...
                    "url_img" => asset('themes/DefaultTheme/images/wink.png'),
				),
				array(
                    ...
                    "url_img" => asset('themes/DefaultTheme/images/mango.png'),
				),
//				array(
...
//				)
	...
	public function routes()
	{
		...
		Route::group(['middleware' => 'auth'], function() {
			...
			Route::get('/doencounter', 'App\Http\Controllers\EncounterPluginController@doEncounter');
			...
			Route::post('mylikes', 'App\Http\Controllers\EncounterPluginController@myLikes');
			Route::post('wholikes', 'App\Http\Controllers\EncounterPluginController@whoLikes');
//            Route::get('/api/encounters',"App\Http\Controllers\EncounterApiController@encounters");
//            Route::get('/api/matches', "App\Http\Controllers\EncounterApiController@matches");

//            Route::get('/api/likes', "App\Http\Controllers\EncounterApiController@likes");
		});
		...
		Api::route('mylikes', $nspace."EncounterApiController@myLikes");
                ...
                Api::route('encounter/setencountersseen', $nspace."EncounterApiController@setEncountersSeen");
                Api::route('encounter/setmatchesseen', $nspace."EncounterApiController@setMatchesSeen");

		Api::route('last-encounter-user', $nspace."EncounterApiController@lastEncounterUser");
