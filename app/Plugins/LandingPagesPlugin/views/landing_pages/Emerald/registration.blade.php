...
<html>
    ...
    <body>
        ...
        <div class="col-md-12 col_bg_img col_main-height bg_size" style="background:url('@if($website_backgroundimage) {{{asset("uploads/backgroundimage/{$website_backgroundimage}")}}} @else @plugin_asset('LandingPagesPlugin/Emerald/images/bg.png') @endif');background-size:cover;">
        <div class="row">
            <div class="@if($only_social_logins == 'true') col-md-12 makeitcenter @else col-md-6 @endif col-xs-12 col_main-text-margin text-center">
                ...
                <p class="text_white head_opacity ">{{{trans_choice('LandingPagesPlugin.first_screen_main_heading_sub',1)}}}</p>
            ...
            <div class="col-md-4 form_margin form_bg form_padding form_width form_boxshadow">
                <h4 class="text_white text-center opacity_7 header_margin">{{{trans_choice('LandingPagesPlugin.signup_top',3)}}}</h4>
                ...
                <div class="form-group form_group_margin-bottom">
                    <div class="row">
                        ...
                        <input autocomplete="off" name="city" placeholder="{{{trans('app.city')}}}" class="form-control remove_boxshadow input_height " id="txtPlaces1" type="text" data-toggle="tooltip" title="Location Required" data-placement="right">
            ...
            <div class="form-group form_group_margin-bottom">
                ...
                <div class="row" style="padding-left:13px;margin-bottom:-7px;padding-right: 6px;">
                    @foreach($sections as $section)
                    @foreach($section->fields as $field)
                    @if($field->on_registration == 'yes' && $field->type == "dropdown")
                    <div class="col-md-6 col-xs-6" style="margin-right: 0px;
                        padding-right: 9px;">
                        <select  name="{{{ $field->code }}}" class="form-control custom-field remove_boxshadow input_height input_max_width input_max_margin" id="{{{$field->code}}}" >
                    ...
                    <div class="col-md-6 col-xs-6" style="padding-right: 7px;">
                        <select  name="{{{ $gender->code }}}" class="form-control remove_boxshadow input_height input_max_width input_max_margin" id="{{{$gender->code}}}" style="margin-bottom:7px">
        ...
        <div class="col-md-12 col_two_padding">
            <div class="container">
                <h4 class="img_col_margin opacity_7">{{{trans_choice('LandingPagesPlugin.testimonials_heading',7)}}}</h4>
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <div class="col-md-2 col-sm-6 col-xs-12">
                                    <a href="#">
                                        <img src="@LandingPageImage('testimonial_one_image')" class="img-responsive">
                                        <div class="col-md-12">
                                            <h5 class="text_black opacity_7">{{{trans_choice('LandingPagesPlugin.testimonial_one_name',0)}}}</h5>
                                            <p class="text_black opacity_7">{{{trans('LandingPagesPlugin.testimonial_one_age')}}}, {{{trans('LandingPagesPlugin.testimonial_one_country')}}}</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-2 col-sm-6 col-xs-12">
                                    <a href="#">
                                        <img src="@LandingPageImage('testimonial_two_image')" class="img-responsive">
                                        <div class="col-md-12">
                                            <h5 class="text_black opacity_7">{{{trans_choice('LandingPagesPlugin.testimonial_two_name',0)}}}</h5>
                                            <p class="text_black opacity_7">{{{trans('LandingPagesPlugin.testimonial_two_age')}}}, {{{trans('LandingPagesPlugin.testimonial_two_country')}}}</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-2 col-sm-6 col-xs-12">
                                    <a href="#">
                                        <img src="@LandingPageImage('testimonial_three_image')" class="img-responsive">
                                        <div class="col-md-12">
                                            <h5 class="text_black opacity_7">{{{trans_choice('LandingPagesPlugin.testimonial_three_name',0)}}}</h5>
                                            <p class="text_black opacity_7">{{{trans('LandingPagesPlugin.testimonial_three_age')}}}, {{{trans('LandingPagesPlugin.testimonial_three_country')}}}</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-2 col-sm-6 col-xs-12">
                                    <a href="#">
                                        <img src="@LandingPageImage('testimonial_four_image')" class="img-responsive">
                                        <div class="col-md-12">
                                            <h5 class="text_black opacity_7">{{{trans_choice('LandingPagesPlugin.testimonial_four_name',0)}}}</h5>
                                            <p class="text_black opacity_7">{{{trans('LandingPagesPlugin.testimonial_four_age')}}}, {{{trans('LandingPagesPlugin.testimonial_four_country')}}}</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-2 col-sm-6 col-xs-12">
                                    <a href="#">
                                        <img src="@LandingPageImage('testimonial_five_image')" class="img-responsive">
                                        <div class="col-md-12">
                                            <h5 class="text_black opacity_7">{{{trans_choice('LandingPagesPlugin.testimonial_five_name',0)}}}</h5>
                                            <p class="text_black opacity_7">{{{trans('LandingPagesPlugin.testimonial_five_age')}}}, {{{trans('LandingPagesPlugin.testimonial_five_country')}}}</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-2 col-sm-6 col-xs-12">
                                    <a href="#">
                                        <img src="@LandingPageImage('testimonial_six_image')" class="img-responsive">
                                        <div class="col-md-12">
                                            <h5 class="text_black opacity_7">{{{trans_choice('LandingPagesPlugin.testimonial_six_name',0)}}}</h5>
                                            <p class="text_black opacity_7">{{{trans('LandingPagesPlugin.testimonial_six_age')}}}, {{{trans('LandingPagesPlugin.testimonial_six_country')}}}</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-2 col-sm-6 col-xs-12">
                                    <a href="#">
                                        <img src="@LandingPageImage('testimonial_seven_image')" class="img-responsive">
                                        <div class="col-md-12">
                                            <h5 class="text_black opacity_7">{{{trans_choice('LandingPagesPlugin.testimonial_seven_name',0)}}}</h5>
                                            <p class="text_black opacity_7">{{{trans('LandingPagesPlugin.testimonial_seven_age')}}}, {{{trans('LandingPagesPlugin.testimonial_seven_country')}}}</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-2 col-sm-6 col-xs-12">
                                    <a href="#">
                                        <img src="@LandingPageImage('testimonial_eight_image')" class="img-responsive">
                                        <div class="col-md-12">
                                            <h5 class="text_black opacity_7">{{{trans_choice('LandingPagesPlugin.testimonial_eight_name',0)}}}</h5>
                                            <p class="text_black opacity_7">{{{trans('LandingPagesPlugin.testimonial_eight_age')}}}, {{{trans('LandingPagesPlugin.testimonial_eight_country')}}}</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
        ...
        <div class="col-md-12 col_three_padding col_three-bg" style='background:url("@LandingPageImage('middle_screen_background_image')")'>
        <div class="text-center">
            <h3 class="text_white">{{{trans_choice('LandingPagesPlugin.middle_screen_heading',0)}}}</h3>
            <h2 class="text_white">{{{trans_choice('LandingPagesPlugin.middle_screen_heading_sub',0)}}}</h2>
        </div>
        </div>
        ...
        <div class="col-md-12 col_last_bg">
            ...
            <div class="text-center">
                <h5 class="text_white footer_margin">{{{trans_choice('LandingPagesPlugin.made_with',15)}}} <i class="fa red fa-heart"></i></h5>
            </div>
        </div>
