...
<html>
    ...
    <div class="col-md-12 header-height header-bg header-padding absolute-position z_index-change">
        ...
        <ul class="list-inline display_inline float_right display_flex">
            <li class="  opacity_7 signin_padding">{{{trans_choice('LandingPagesPlugin.df_one_singin',1)}}}</li>
            <li class="li-padding">
    ...
    <div class="col-md-12 col_bg_img col_main-height bg_size">
        <div class="row">
            <div class="@if($only_social_logins == 'true') col-md-12 makeitcenter @else col-md-6 @endif col-xs-12 col_main-text-margin text-center">
                <h3 class="text-center   head_opacity header_green">{{{trans_choice('LandingPagesPlugin.first_screen_main_heading',1)}}}</span></h3>
                <p class="text-center   users_para_padding opacity_7">{{{trans_choice('LandingPagesPlugin.first_screen_main_heading_sub',0)}}}</p>
    ...
    <script src="@plugin_asset('LandingPagesPlugin/RainbowV2/js/bootstrap-datepicker.js')"></script>
    <script>
        $(document).ready(function() {
          $('#datetimepicker')
                .datepicker({
