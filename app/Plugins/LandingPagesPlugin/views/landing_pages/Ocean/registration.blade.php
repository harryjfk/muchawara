...
<html>
    <head>
        ...
        <link rel="stylesheet" href="@plugin_asset('LandingPagesPlugin/Ocean/css/datingframework_sweet.css')">
    ...
    <body style="background:url('@if($website_backgroundimage) {{{asset("uploads/backgroundimage/{$website_backgroundimage}")}}} @else @plugin_asset('LandingPagesPlugin/Ocean/images/african-bg.jpg') @endif');background-size:cover;">
    ...
    <div class="col-md-12 header-height header-bg header-padding absolute-position z_index-change">
        <ul class="list-inline display_inline float_right display_flex">
            <li>
                <p class="text_white opacity_7 signin_padding">{{{trans_choice('LandingPagesPlugin.df_two_reg',0)}}}</p>
            </li>
            <li class="li-padding">
            ...
            <div class="@if($only_social_logins == 'true') col-md-12 makeitcenter @else col-md-6 @endif col-xs-12 col_main-text-margin text-center">
                ...
                <div>
                    <ul class="list-inline text_white">
                        ...
                        <li class=" social_padding_right opacity_7" onclick="window.location.href='@LandingPageUrl('privacy_policy')'">{{{trans_choice('LandingPagesPlugin.privacy_policy',6)}}}</li>
                    </ul>
                </div>
            </div>
    ...
    <script src="@plugin_asset('LandingPagesPlugin/Ocean/js/bootstrap-datepicker.js')"></script>
    <script>
        $(document).ready(function() {
            $('#datetimepicker')
                .datepicker({
