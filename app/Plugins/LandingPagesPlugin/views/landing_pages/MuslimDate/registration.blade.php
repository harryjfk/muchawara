...
<html>
    ...
    <body>
        ...
        <div class="col-md-12 col-xs-12 header-height header-bg header-padding absolute-position z_index-change">
        ...
        <div class="col-md-12 col-xs-12 col_bg_img col_main-height bg_size" style=" background:url('@if($website_backgroundimage) {{{asset("uploads/backgroundimage/{$website_backgroundimage}")}}} @else @plugin_asset('LandingPagesPlugin/MuslimDate/images/top-img.png') @endif');">
        ...
        <div class="row">
            <div class="col-md-12 col-xs-12 col_two-height col_two_bg">
                <div class="col-md-10 col-xs-12 col_two_main_height col_two_main_bg absolute_position col_two_margin col_two_main_padding z_index-change">
                    <div class="col-md-12 col-xs-12">
                        <h3 class="text_white opacity_7 font_bold">{{{trans_choice('LandingPagesPlugin.middle_content_first_heading',4)}}}</h3>
                        <p class="text_white line_height opacity_7">{{{trans_choice('LandingPagesPlugin.middle_content_first_description',5)}}}</p>
                    </div>
                    <div class="col-md-12 col-xs-12 margin_last">
                        <h3 class="text_white opacity_7 font_bold">{{{trans_choice('LandingPagesPlugin.middle_content_second_heading',6)}}}</h3>
                        <p class="text_white line_height opacity_7">{{{trans_choice('LandingPagesPlugin.middle_content_second_description',7)}}}</p>
                    </div>
                    <div class="col-md-12 col-xs-12 margin_last">
                        <h3 class="text_white opacity_7 font_bold">{{{trans_choice('LandingPagesPlugin.middle_content_third_heading',8)}}}</h3>
                        <p class="text_white line_height opacity_7">{{{trans_choice('LandingPagesPlugin.middle_content_third_description',9)}}}</p>
                    </div>
                    <div class="col-md-12 col-xs-12 text-center margin_last">
                        <h4 class="text-center text_white opacity_9 font_17 font_bold">{{{trans_choice('LandingPagesPlugin.middle_content_button_top_text',10)}}}</h4>
                        <button type="button" class="btn btn-success btn-lg btn_join_padding btn-border_radius btn_border1" onclick="window.location.href='@LandingPageUrl('middle_content_button_url')'">{{{trans_choice('LandingPagesPlugin.middle_content_button_text',11)}}}</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 col-xs-12 col_three_height col_three_bg" style="background:url(@LandingPageImage('testimonial_background_image'))">
                <h1 class="text_white text-center header_margin_top font_bold">{{{trans_choice('LandingPagesPlugin.df_eight_reg',12)}}}</h1>
                <div class="container">
                    <div class="row">
                        <div class="col-md-12" data-wow-delay="0.2s">
                            <div class="carousel slide" data-ride="carousel" id="quote-carousel">
                                ...
                                <ol class="carousel-indicators">
                                    <li data-target="#quote-carousel" data-slide-to="0" class="active"><img class="img-responsive " src="@LandingPageImage('testimonial_one_image')" alt="">
                                    </li>
                                    <li data-target="#quote-carousel" data-slide-to="1"><img class="img-responsive" src="@LandingPageImage('testimonial_two_image')" alt="">
                                    </li>
                                    <li data-target="#quote-carousel" data-slide-to="2"><img class="img-responsive" src="@LandingPageImage('testimonial_three_image')" alt="">
                                    </li>
                                    <li data-target="#quote-carousel" data-slide-to="3"><img class="img-responsive" src="@LandingPageImage('testimonial_four_image')" alt="">
                                    </li>
                                    <li data-target="#quote-carousel" data-slide-to="4"><img class="img-responsive" src="@LandingPageImage('testimonial_five_image')" alt="">
                                    </li>
                                    <li data-target="#quote-carousel" data-slide-to="5"><img class="img-responsive" src="@LandingPageImage('testimonial_six_image')" alt="">
                                    </li>
                                    <li data-target="#quote-carousel" data-slide-to="6"><img class="img-responsive" src="@LandingPageImage('testimonial_seven_image')" alt="">
                                    </li>
                                    <li data-target="#quote-carousel" data-slide-to="7"><img class="img-responsive" src="@LandingPageImage('testimonial_eight_image')" alt="">
                                    </li>
                                </ol>
                                ...
                                <div class="carousel-inner text-center">
                                        ...
                                        <blockquote>
                                            <div class="row">
                                                <div class="col-sm-8 col-sm-offset-2">
                                                    <p class="whitetext">{{{trans('LandingPagesPlugin.testimonial_one_name')}}}</p>
                                                    <small>{{{trans('LandingPagesPlugin.testimonial_one_description')}}}<br/>
                                                    </small>
                                                </div>
                                            </div>
                                        </blockquote>
                                    ...
                                    <div class="item">
                                        <blockquote>
                                            <div class="row">
                                                <div class="col-sm-8 col-sm-offset-2">
                                                    <p class="whitetext">{{{trans('LandingPagesPlugin.testimonial_one_name')}}}</p>
                                                    <small>{{{trans('LandingPagesPlugin.testimonial_two_description')}}}</small>
                                                </div>
                                            </div>
                                        </blockquote>
                                    </div>
                                    ...
                                    <div class="item">
                                        <blockquote>
                                            <div class="row">
                                                <div class="col-sm-8 col-sm-offset-2">
                                                    <p class="whitetext">{{{trans('LandingPagesPlugin.testimonial_three_name')}}}</p>
                                                    <small>{{{trans('LandingPagesPlugin.testimonial_three_description')}}}</small>
                                                </div>
                                            </div>
                                        </blockquote>
                                    </div>
                                    <div class="item">
                                        <blockquote>
                                            <div class="row">
                                                <div class="col-sm-8 col-sm-offset-2">
                                                    <p class="whitetext">{{{trans('LandingPagesPlugin.testimonial_four_name')}}}</p>
                                                    <small>{{{trans('LandingPagesPlugin.testimonial_four_description')}}}</small>
                                                </div>
                                            </div>
                                        </blockquote>
                                    </div>
                                    <div class="item">
                                        <blockquote>
                                            <div class="row">
                                                <div class="col-sm-8 col-sm-offset-2">
                                                    <p class="whitetext">{{{trans('LandingPagesPlugin.testimonial_five_name')}}}</p>
                                                    <small>{{{trans('LandingPagesPlugin.testimonial_five_description')}}}</small>
                                                </div>
                                            </div>
                                        </blockquote>
                                    </div>
                                    <div class="item">
                                        <blockquote>
                                            <div class="row">
                                                <div class="col-sm-8 col-sm-offset-2">
                                                    <p class="whitetext">{{{trans('LandingPagesPlugin.testimonial_six_name')}}}</p>
                                                    <small>{{{trans('LandingPagesPlugin.testimonial_six_description')}}}</small>
                                                </div>
                                            </div>
                                        </blockquote>
                                    </div>
                                    <div class="item">
                                        <blockquote>
                                            <div class="row">
                                                <div class="col-sm-8 col-sm-offset-2">
                                                    <p class="whitetext">{{{trans('LandingPagesPlugin.testimonial_seven_name')}}}</p>
                                                    <small>{{{trans('LandingPagesPlugin.testimonial_seven_description')}}}</small>
                                                </div>
                                            </div>
                                        </blockquote>
                                    </div>
                                    <div class="item">
                                        <blockquote>
                                            <div class="row">
                                                <div class="col-sm-8 col-sm-offset-2">
                                                    <p class="whitetext">{{{trans('LandingPagesPlugin.testimonial_eight_name')}}}</p>
                                                    <small>{{{trans('LandingPagesPlugin.testimonial_eight_description')}}}</small>
                                                </div>
                                            </div>
                                        </blockquote>
                                    </div>
        ...
        <div class="row">
            <div class="col-md-12 col-xs-12 col_last_bg">
                ...
                <div class="text-center">
                    <h5 class="text_white footer_margin">{{{trans_choice('LandingPagesPlugin.made_with',15)}}} <img class="like-width" src="@plugin_asset('LandingPagesPlugin/images/like.png')"> {{{trans_choice('LandingPagesPlugin.by',16)}}} Squareloop</h5>
                </div>
            </div>
        </div>
        <script>
