 ...
 <div class="col-md-12 header-height header-bg header-padding absolute-position z_index-change">
      ...
      {{{Theme::render('login')}}}   
        <li>
          ...
          <!-- <p class="text_white display_inline social_p_margin opacity_7">{{{trans('LandingPagesPlugin.sign_up_with')}}}</p> -->
    ...
    <div class="row">
      <div class="text-center col_main_col_padding">
        ...
        <h4 class="text-center text_white">{{{trans_choice('LandingPagesPlugin.first_screen_main_heading_sub',0)}}}</h4>
...
-->
   ...
   <div class="col-md-12 col_4_padding">
    ...
    <!--<div class="col-md-12 text-center col_4_padding">
     <div class="download_app_margin_top">
           <p class="text_black opacity_7">Download our App from</p>
           <ul class="list-inline display_inline">
           <li>
