...
class GayDate implements LandingPageInterface {
	...
	public function contentSections() {
		return [			
			"first_screen_main_heading_bold_text",'welcome_to',"made_with","app_available_market_place_heading","app_available_market_place_heading_sub", 'remember_me',
	...
	public function imageSections() {
		return [
			"testimonial_background_image" => [
				'url' => url("plugins/LandingPagesPlugin/GayDate/images/bottom-img.png")
			],
