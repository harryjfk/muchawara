...
<html>
    ...
    <body>
        ...
        <div class="col-md-12 col_bg_img col_main-height bg_size signin-col-main" 
        style="background:url('@if($website_backgroundimage) {{{asset("uploads/backgroundimage/{$website_backgroundimage}")}}} @else @plugin_asset('LandingPagesPlugin/GayDate/images/top-img.png') @endif'); background-size: cover; height:100vh;">
        ...
        <div class="col-md-4 float_right form_margin form_bg form_padding form_width" @if($only_social_logins == 'true') style="display:none" @endif>
