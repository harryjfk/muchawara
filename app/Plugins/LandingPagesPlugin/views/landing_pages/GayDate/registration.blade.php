...
<html>
    <head>
        ...
        <link rel="stylesheet" href="@plugin_asset('LandingPagesPlugin/GayDate/css/gaymatchup.css')">
    ...
    <body>
        ...
        style="background:url('@if($website_backgroundimage) {{{asset("uploads/backgroundimage/{$website_backgroundimage}")}}} @else @plugin_asset('LandingPagesPlugin/GayDate/images/top-img.png') @endif')">
        <div class="row" style="margin-bottom: 40px;">
            <div class="@if($only_social_logins == 'true') col-md-12 makeitcenter @else col-md-6 @endif col-xs-12 col_main-text-margin text-center">
                <h2 class="text-center text_white head_opacity">{{{trans_choice('LandingPagesPlugin.welcome_to',0)}}} 
                    <span class="bold_heading">{{{trans_choice('LandingPagesPlugin.first_screen_main_heading_bold_text',1)}}}</span>
                </h2>
                <h3 class="text-center text_white" style="margin: 2%;
                    font-size: 15px;">{{{trans_choice('LandingPagesPlugin.first_screen_main_heading_sub',2)}}}</h3>
                <div class="text-center social_margin social_login_cnt">
        ...
        <div class="row">
            <div class="col-md-12 col_two-height col_two_bg">
                <div class="text-center devices_padding">
                    <h3 class="text_white opacity_7">{{{trans_choice('LandingPagesPlugin.app_available_market_place_heading',2)}}}</h3>
                    <h5 class="text_white text-center opacity_7">{{{trans_choice('LandingPagesPlugin.app_available_market_place_heading_sub',3)}}}</h5>
                    <img class="device_img_margin" src='@LandingPageImage('app_available_market_place_image')'>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 col_three_height" style="background:url('@LandingPageImage('testimonial_background_image')")');
            background-size: cover;">
            <h1 class="text_white text-center header_margin_top">{{{trans_choice('LandingPagesPlugin.testimonials_heading',12)}}}</h1>
            <div class="container">
                <div class="row">
