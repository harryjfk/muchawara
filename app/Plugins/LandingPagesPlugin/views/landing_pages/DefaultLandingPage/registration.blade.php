...
<html>
    <head>
        ...
        <link rel="stylesheet" href="@theme_asset('css/animate.min.css')" type="text/css">
        <!-- load animate -->
        ...
        <style>
            ...
            background: linear-gradient(#1689fb,#155de4);
            }
        </style>
    </head>
    ...
    <div class="col-md-12 col_bg_img col_main-height bg_size">
        ...
        <div class="row">
            <div class="@if($only_social_logins == 'true') col-md-12 makeitcenter @else col-md-6 @endif col-xs-12 col_main-text-margin text-center">
                ...
                <p class="opacity_7 text-center" >{{{trans_choice('LandingPagesPlugin.first_screen_main_heading_sub',1)}}}
	                <span style="font-size: 15px;color:#fc4d1e">{{$total_signups}}</span>
    ...
    <script type="text/javascript" src="@theme_asset('js/wow.js')"></script>
    <script>
