...
class LandingPagesController extends Controller {
    ...
    public function showSetting () {
        ...
        return Plugin::view('LandingPagesPlugin/admin_landing_pages_setting', [
            ...
            'follow_us_links'               => LandingPageRepository::allFollowUsLinks()
        ]);
    ...
    public function createFollowUsLink(Request $request)
    {
        $response = LandingPageRepository::createFollowUsLink(
            $request->icon_script,
            $request->label,
            $request->hover_text,
    ...
    public function deleteFollowUsLink(Request $request)
    {
        $response = LandingPageRepository::deleteFollowUsLink($request->id);
        return response()->json($response);
    }


    public function activateFollowUsLink(Request $request) 
    {
        $response = LandingPageRepository::activateFollowUsLink($request->id, $request->activate);
        return response()->json($response);
    }
