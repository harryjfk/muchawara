...
class PaypalPlugin extends PluginAbstract
{
	...
	public function routes()
	{
		...
		Api::route('paypal/packages', $nspace."PaypalController@getPackages", 'no-api');
		Api::route('paypal/buy/credits', $nspace."PaypalController@buyCredits");
		Api::route('paypal/buy/superpower', $nspace."PaypalController@buySuperpower");
