...
class PeopleNearByPlugin extends PluginAbstract
{
	...
	public function routes()
	{
		Route::group(['middleware' => 'auth'], function(){
            ...
            Route::get('countryCityFilter', 'App\Http\Controllers\PeopleNearByController@countryCityFilter');
		});
		...
		Api::route('people-nearby/filter-settings', $nspace.'PeopleNearByApiController@getSearchFilterSettings');


		Api::route('boost/check', $nspace.'PeopleNearByApiController@checkBoost');
        Api::route('countryCityFilter', $nspace.'PeopleNearByApiController@countryCityFilter');
