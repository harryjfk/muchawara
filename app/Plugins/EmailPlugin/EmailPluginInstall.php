...
class EmailPluginInstall extends PluginInstall
{
	public function install()
	{
		...
		$forgot_pasword->subject = "Recupera su contraseña";
		...
		$account_activation->content = "<link href="@theme_asset('css/bootstrap.min.css')" rel="stylesheet" type="text/css">.php";
		...
		$liked->subject = "Tienes un nuevo ADMIRADOR";
		...
		$match->subject = "Hay alguien que quiere WARA";
		...
		$change_email->content = "<link href="@theme_asset('css/bootstrap.min.css')" rel="stylesheet" type="text/css">.php";
