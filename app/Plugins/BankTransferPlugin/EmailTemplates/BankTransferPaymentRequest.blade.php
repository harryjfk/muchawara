                    ...
                    <table align="center" border="1" cellpadding="0" cellspacing="0" width="600px" style="border-collapse: collapse;border-color:rgba(0, 0, 0, 0.07);box-shadow: 0px 2px 5px #888888;">
                        <tr>
                            <td style="background-color: #FFFFFF;padding:0px 0px 10px 24px;border-top: 2px solid #FF4E79;">
                                ...
                                <p style="font-size: 18px;margin-top: 24px;margin-left:6px;opacity:0.8;font-family: 'Roboto';">{{{trans('BankTransferPlugin.payment_request_mail_header')}}}</p>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 24px 24px 0px 24px;background-color: #FFFFFF;">
                                <div style="    background: #FFFFFF;
                                    ...
                                    <h4 style="   color: rgb(102, 102, 102);
                                        ...
                                        -webkit-margin-end: 0px;position:relative;top:-12px;margin-bottom:0px;"><span>{{trans('BankTransferPlugin.hi')}}, {{{$user->name}}}</span></h4>
                                      
                                </div>
                                <div style="
                                    display: inline-block;">
                                    <img src="{{{$user2->profile_pic_url()}}}" style="object-fit:cover" width="100" height="100" />
                                    {{$user2->name}}
                                    {{trans('BankTransferPlugin.requested_for_bank_transfer_text')}}
                                </div>
                                <div style="width: 300px;  padding-top: 14px;
                                    ...
                                    <p style="  display: inline;
                                        font-size: 16px;
                                        color: black;
                                        opacity: 0.87;margin: 0 0 10px;"></p>
                                    <a href="{{{url('/admin/plugin/bank-transfer/requests/porocessing')}}}"  style="margin-top: 24px!important;background-color: #1AC636;color: #fff;
                                        ...
                                        padding-left: 10px;
                                        padding-right: 10px;
                                        background-color: #1AC636;width:106px;border-radius:23px;">{{{trans('BankTransferPlugin.see_requests')}}}</a>
                                </div>
                            </td>
                        </tr>
                        <tr>
