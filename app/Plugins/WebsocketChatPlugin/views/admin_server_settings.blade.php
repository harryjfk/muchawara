                ...
                <form action = "" method = "POST" id = "settings-save-form">
                    ...
                    <div class="col-md-10 add-creditpackage-col admin-create-div">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control  input-border-custom" name ="websocket_key" style="height:100px;">{{$websocket_key}}</textarea>
                        </div>
            ...
            <div class="row" style="margin-top:10px">
                <div class="col-md-10 add-creditpackage-col admin-create-div">
                    ...
                    <div class="form-group">
                        ...
                        <textarea placeholder=""  id="output" style="height:250px" class="form-control input-border-custom">{{{$server_status}}}</textarea>
                    </div>
                </div>
            </div>
