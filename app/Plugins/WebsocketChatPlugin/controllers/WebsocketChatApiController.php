...
class WebsocketChatApiController extends Controller
{
    ...
    public function getChatUsers(Request $req) 
    {
        ...
        return response()->json([
            ...
            "chat_users" => $chat_data["chat_users"], 
    ...
    public function getMessages(Request $req) 
    {
        ...
        $loadMore = false;
        $messages = chatRepo::getMessages($user_id, $contact_id, $last_message_id, $loadMore);        
    ...
    public function markRead (Request $req) 
    {
        ...
        if ($req->read_all == 'true') {
            ...
            if(is_null($req->other_user_id)) {
                return response()->json([
                    "status" => "error", 
                    "error_type" => "OTHER_USER_ID_REQUIRED",
                    "success_text" => "Other UsersID required" 
                ]);
            }
