...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function initNeededModels()
    {
        ...
        $this->userSuperPower = $this->app->make("App\Models\UserSuperPowers");
    }
    ...
    public function create_profile($user)
    {
        ...
        $profile->prefer_gender = app('App\Repositories\Admin\GeneralManageRepository')->getPreferGendersWithCommaSeperated($user->gender);
    ...
    public function add_super_powers($user)
    {
            $defaultsuperpower = $this->settings->get('defaultsuperpower');
            $user_superpower = new $this->userSuperPower;
            $user_superpower->user_id =  $user->id;
            $user_superpower->invisible_mode = false;
            $user_superpower->hide_superpowers = 0;
            $user_superpower->expired_at = date('Y-m-d', strtotime("+{$defaultsuperpower} days", strtotime(date('Y-m-d'))));
