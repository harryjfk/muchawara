...
class CreditManageController extends Controller {
    ...
    public function creditManage () {
        ...
        $data = [
            ...
            'defaultsuperpower'               => UtilityRepository::get_setting('defaultsuperpower'),
            'add_bullets_by_commands'         => UtilityRepository::get_setting('add_bullets_by_commands'),
        ];
    ...
    public function defaultSuperPower (Request $request) {

        try {

            if ($request->defaultsuperpower == '') {

                return response()->json(['status' => 'error', 'message' => trans_choice('admin.default_super_power_msg', 0)]);    
            }

            UtilityRepository::set_setting('defaultsuperpower', $request->defaultsuperpower);
            
            return response()->json(['status' => 'success', 'message' => trans_choice('admin.default_super_power_msg', 1)]);

        } catch (\Exception $e) {

            return response()->json(['status' => 'error', 'message' => trans_choice('admin.default_super_power_msg', 2)]);
    ...
    public function addBulletsCommands (Request $request) {
        ...
        try {
            ...
            UtilityRepository::set_setting('add_bullets_by_commands', $request->credits);

            return response()->json(['status' => 'success', 'message' => trans_choice('admin.add_bullets_by_commands', 1)]);

        } catch (\Exception $e) {

            return response()->json(['status' => 'error', 'message' => trans_choice('admin.add_bullets_by_commands', 2)]);
