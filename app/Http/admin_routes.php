...
Route::group(['middleware' => 'afterAdminLogin'], function(){   
    ...
    Route::post('admin/login/otp/resend', 'Admin\AuthenticationController@resendOtp');
    Route::post('admin/login/otp/verify', 'Admin\AuthenticationController@verifyOtp');
});
...
Route::group(['middleware' => 'admin'], function(){
	...
	Route::post('/admin/users/usermanagement/doaction', 'Admin\UserManagementController@doUserManagementAction');
        ...
        //Estadísticas
	Route::get('admin/users/usermanagement/statics', 'Admin\UserManagementController@getStatics');
	
	Route::post('admin/users/usermanagement/send-users-notification', 'Admin\UserManagementController@sendUserNotifications');
	Route::post('admin/users/usermanagement/send-users-email', 'Admin\UserManagementController@sendUserEmail');
    ...
    Route::get("admin/admnmanagement/accessible-routes/{admin_id}", "Admin\AdminManagementController@showAdminAccessibleRoutes");
    Route::post("admin/admnmanagement/accessible-routes/save", "Admin\AdminManagementController@saveAdminAccessibleRoutes");
    Route::post("admin/admnmanagement/two-factor-auth/save", "Admin\AdminManagementController@saveAdminTwoFactorAuth");
	...
	Route::post('/admin/settings/socialLoginSettings', 'Admin\SocialLoginsController@save_priority');
        ...
        Route:get('/admin/wara', 'Admin\DashboardController@wara');
	//end of code
...
Route::group(['middleware' => 'admin'], function(){
	...
	Route::post('/admin/creditManage/addBulletsCommands', 'Admin\CreditManageController@addBulletsCommands');
	...
	Route::post('/admin/creditManage/defaultSuperPower', 'Admin\CreditManageController@defaultSuperPower');
...
Route::group(['middleware' => 'admin'], function(){
	...
	Route::post('admin/generalSettings/default-after-login-route', 'Admin\GeneralSettingsController@saveAfterLoginRoute');
	...
	Route::post('admin/generalSettings/domain/save', 'Admin\GeneralSettingsController@saveDomain');
	Route::post('/admin/generalSettings/title', 'Admin\GeneralSettingsController@setTitle');
	Route::post('/admin/generalSettings/msg_text', 'Admin\GeneralSettingsController@setMsgText');
	Route::post('/admin/generalSettings/upload_url', 'Admin\GeneralSettingsController@setUploadUrl');
	Route::post('/admin/generalSettings/msg_difusion', 'Admin\GeneralSettingsController@setMsgDifusion');
...
Route::group(['middleware' => 'admin'], function() {	
	...
	Route::get('admin/settings/cron', 'Admin\CronController@showSettings');
	Route::post('admin/settings/cron/php/path/save', 'Admin\CronController@savePHPPath');
	Route::post('admin/settings/cron/restart', 'Admin\CronController@restartCron');
	Route::post('admin/settings/cron/stop', 'Admin\CronController@stopCron');

});


/*script setting routes*/
Route::group(['middleware' => 'admin'], function() {	
	Route::get('admin/settings/scripts', 'Admin\ScriptsController@showSetting');
	Route::post('admin/settings/scripts/save', 'Admin\ScriptsController@saveSetting');
});


Route::group(["middleware" => "admin"], function(){
	Route::get('admin/settings/twilio', 'Admin\TwilioOtpController@showSetting');
	Route::post('admin/settings/twilio/save', 'Admin\TwilioOtpController@saveSetting');
});
