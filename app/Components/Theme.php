...
class Theme
{
	...
	protected static $hook_list = [
		...
		'login'                   => [],
		'admin_plugin_menu'       => [],
		'internal_header_scripts' => [["App\Components\Theme", "RegisterInternalHeaderScripts"]],
		'internal_footer_scripts' => [["App\Components\Theme", "RegisterInternalFooterScripts"]],
		'landing_header_scripts'  => [["App\Components\Theme", "RegisterLandingHeaderScripts"]],
		'landing_footer_scripts'  => [["App\Components\Theme", "RegisterLandingFooterScripts"]]
	];



	protected static function RegisterLandingFooterScripts()
	{
		return Settings::get("landing_footer_scripts");
	}


	protected static function RegisterLandingHeaderScripts()
	{
		return Settings::get("landing_header_scripts");
	}


	protected static function RegisterInternalHeaderScripts()
	{
		return Settings::get("internal_header_scripts");
	}



	protected static function RegisterInternalFooterScripts()
	{
		return Settings::get("internal_footer_scripts");
	}
			...
			if( isset(self::$modifier[$hookName]) )
			{
				...
				foreach(self::$modifier[$hookName] as $modFunc)
				{
					...
					foreach(self::$hook_list[$hookName] as $contFunc)
					{
						...
						$data = call_user_func_array($contFunc, $args);
