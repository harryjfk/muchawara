...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
        ...
        \App\Console\Commands\CronStatus::class,
        \App\Console\Commands\DeleteUserSpotlight::class,
        \App\Console\Commands\BalasPeriodoTiempo::class,
        \App\Console\Commands\DeleteUserSpotlight::class,
        \App\Console\Commands\ConnectSeverChat::class
    ];
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('delete:user:spotlight')->hourly();
        
         $schedule->command('server_chat:start')->hourly();
