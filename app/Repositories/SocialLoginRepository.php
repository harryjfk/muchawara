...
class SocialLoginRepository
{
	...
	public function login()
	{
		...
		return ['user' => $this->getUser(), 'msg' => trans('admin.account_ban_by_admin'), 'login' => false];
	}
	...
	public function checkDataIncomplete()
	{
        ...
        $dob_string = is_object($user->dob) ? $user->dob->format("Y-m-d") : $user->dob;

        if(is_null($dob_string) || $dob_string == "0000-00-00" || \Carbon\Carbon::parse($dob_string)->diffInYears(\Carbon\Carbon::now()) < 18) {
