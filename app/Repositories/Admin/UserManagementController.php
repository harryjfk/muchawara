...
class UserManagementController extends Controller {
    ...
    public function showUserManagement (Request $request) {
        ...
        return view('admin.admin_usermanagement', [
            'users' => $this->userManageRepo->getAllActivatedUsers($request->search_by_username, $request->search_by_name)
        ]);
    }
    ...
    public function sendUserNotifications(Request $request) 
    {
        ...
        $response = $this->userManageRepo->sendUserNotifications($user_ids, $content);
        return response()->json($response);
    }
	...
	public function sendUserEmail(Request $request) 
    {
        ...
        $response = $this->userManageRepo->sendUserEmail($user_ids, $content,$subject);
        return response()->json($response);
    }

    public function getStatics(){
        
        $statics = $this->userManageRepo->getStatics();
        return view('admin.admin_statics', compact('statics'));
