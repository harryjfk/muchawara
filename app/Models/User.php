                                    ...
                                    CanResetPasswordContract
{
    ...
    protected $fillable = [
        ...
        'dob', 'city', 'country', 'township', 'latitude', 'longitude',
        'activate_user', 'verified', 'hereto', 'status', 'chat_token',
        'activate_token', 'register_from', 'profile_pic_url', 'language', 'take_credits', 'aboutme'
    ];
    
    
    protected $hidden = array('password', 'access_token', 'activate_token', 'password_token','chat_token');
    /**
...
/*
    ...
    public function getLastRequest()
    {
        ...
        return date('d.m.Y', strtotime($this->last_request));
    }
