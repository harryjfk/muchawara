<?php 
 return 
 array (
  'request_sent_success' => 'リクエストが正常に送信され',
  'some_error' => 'いくつかのエラー！お願いします',
  'make_it_public' => 'それは公開します',
  'unlock_private_photos_with_gift_title' => 'ギフトとのプライベート写真のロックを解除',
  'unlock_private_photos_with_gift_label' => 'ギフトとのプライベート写真を有効または無効にロックを解除',
  ...
  'choose_unlock' => 'プライベート写真のロックを解除することを選択します！',
  'send_gifts' => 'ギフトを送る',
