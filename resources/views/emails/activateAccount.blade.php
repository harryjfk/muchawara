...
<td style="padding: 20px 0 30px 0; color: #153643; font-family: Raleway, sans-serif; font-size: 14px; line-height: 20px;">
 
<p>Hola, somos el equipo de WARA y queremos darte la bienvenida.</p>
<p>Por favor, active su cuenta dando click en el vínculo que aparece a continuación.</p>
<p>Muchas gracias</p>
...
<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
 ...
 <a href = "{{{url('sample/activate/')}}}/{{{$user->id}}}/{{{$user->activate_token}}}"  style="margin-top: 0px!important;background-color: #ec650f;color: #fff;
