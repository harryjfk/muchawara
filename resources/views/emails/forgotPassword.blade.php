...
<td style="color: #153643; font-family: Raleway, sans-serif; font-size: 24px;">
 ...
 <b>Siga el vínculo para restablecer su contraseña</b>
...
<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
 ...
 <a href="{{{url('reset')}}}/{{{$user->id}}}/{{{$user->password_token}}}"  style="margin-top: 0px!important;background-color: #ec650f;color: #fff;
