...
<body style="text-decoration: none;margin: 0; padding: 0;background-color:rgba(128, 128, 128, 0.39);font-family: 'Roboto' !important;">
 <table border="1" cellpadding="0" cellspacing="0" width="100%;">
           ...
           <td style="background-color: #FFFFFF;padding:0px 0px 10px 24px;border-top: 2px solid #FF4E79;">
              <div style="display:inline-block;">
                 <div class="row">
                  ...
                  <p style="font-size: 18px;margin-top: 24px;margin-left:11px;opacity:0.8;font-family: 'Roboto';">{{{trans('email.got_gift')}}}</p>
                 </div>
               </div>
  ...
  background-color: #FFFFFF;">
              <p style=" color: black;
  opacity: 0.8;
  font-size: 16px;">{{{trans('email.hi')}}}, {{$user->name}}<br><br>{{$user2->name}} {{{trans('email.sent_you_gift')}}}</p>
