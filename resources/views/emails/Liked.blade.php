...
<img src="{{{url('uploads/email_template/ic_no_photo.png')}}}" width="100" height="100" style="object-fit:cover; border-radius: 50px;  filter: blur(5px);"/>
