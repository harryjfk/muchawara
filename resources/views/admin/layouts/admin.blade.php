                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        @if($guest)
                            ...
                            @foreach($guest_admin_routes as $group)

                                @if($group['accessible_for_admin'])
                                <li class="treeview">
                                    <a href="#">                                
                                ...
                                @foreach($group['routes'] as $route)
                                    @if($route['accessible_for_admin'] && $route['visible'])
                                        <li>
                                            <a href="{{url($route['name'])}}">
                                                <i class="fa fa-circle-o"></i> {{$route['text']}}
                                            </a>
                                        </li>  
                                    @endif
                                @endforeach
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="{{{ url('admin/settings/twilio') }}}"><i class="fa fa-circle-o"></i> {{trans('admin.menu_settings_twilio')}}</a></li>
                                ...
                                <li><a href="{{{ url('/admin/settings/cron') }}}"><i class="fa fa-circle-o"></i> {{trans("cron.menu_text")}}</a></li>
                                <li><a href="{{{ url('admin/settings/scripts') }}}"><i class="fa fa-circle-o"></i> {{trans("script.script_settings_menu")}}</a></li>
