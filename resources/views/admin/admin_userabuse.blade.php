                ...
                <div class="col-md-12 user-dropdown-col">
                    <div class="table-responsive">
                        ...
                        <table class="table" id="user-table">
                            <thead>
                                <tr>
                                    <th style="width: 5%;"><input type="checkbox" id="select_all_unseens" value=""></th>
                                    <th style="width: 15%;">{{trans_choice('admin.reporting_user',1)}}</th>
                                    <th style="width: 15%;">{{trans_choice('admin.reported_user',1)}}</th>
                                    <th style="width: 15%;">{{trans_choice('admin.reason',1)}}</th>
                                    <th style="width: 15%;">{{trans_choice('admin.acciones',1)}}</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if($unseens->count > 0)
                                ...
                                <tr>
                                    ...
                                    <td>{{{ $unseen->reason }}}</td>
                                    <td>
                                        <button class="btn btn-primary green" type="button" id="{{{$unseen->reportinguser->name}}}" ><i class="">Aceptar</i></button>
                                        <button class="btn btn-primary green" type="button"><i class="">Cancelar</i></button>
                                    </td>
                                </tr>
                                @endforeach    
                                @else
