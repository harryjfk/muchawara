...
<div class="col-md-12  pad" ng-controller="EncounterController">
    ...
    <div id="matchModal" class="modal fade" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
    ...
    <div class="cont-cover" ng-show="encounter_list.length">
        ...
        <div class="cont-header">
            <div class="online-u">
                <img ng-src="[[currentUser.profile_pic_url]]"  alt="...">
                <!-- 								<div class="dot-online"> <img src="images/online-ico.png" alt="..."> </div> -->
               
                <div class="dot-online" ng-if="currentUser.onlineStatus"> <img src="images/online-ico.png" alt="..."> </div>
    ...
    <div class="cont-cover" ng-hide="encounter_list.length">
...
<script type="template" id="no_encounter_template">
 ...
 @if(Session::has('data_incomplete') && session::get('data_incomplete')) 
<script type="text/javascript" src="@theme_asset('js/bootstrap-multiselect.min.js')"></script>
@endif
<script>
    			...
    			if($scope.currentUser.islikedme){
    				...
    				$('#matchModal').modal("show");
    				    ...
    				    return Math.abs(ageDate.getUTCFullYear() - 1970);
    						...
    						//$scope.currentUser.userObj = $scope.encounter_list.length;
    						
    						$scope.currentUser.users_photos_count = $scope.encounter_list[0].photos.count;
    						
    						$scope.currentUser.onlineStatus = $scope.encounter_list[0].user.onlineStatus;
...
*/
    	...
    	var promise=$.post("{{{ url('/doencounter') }}}", {  _token: App.csrf_token }).promise();
    	...
    	promise.done(callBack);
    	  ...
    	  function callBack(data){
    				...
    				if(data.status == "no encounter"){
	    				...
	    				$scope.currentUser.id = $scope.encounter_list[0].user.id;
	    				
	    				$scope.currentUser.name = $scope.encounter_list[0].user.name;
				    	$scope.currentUser.age = $scope.encounter_list[0].user.age;
				    	$scope.currentUser.islikedme = $scope.encounter_list[0].islikedme;
