...
<div class="cont-cover mid_body_container">
    <div class="cont-header">
        ...
        <div class="name-c">
           ...
           @if($chat_settings_option != 'match_only') <i class="fa fa-comment-o" id="chat_bubble" data-toggle="tooltip" title="{{trans('app.chat_bubble_tooltip')}}" ng-click="addToContactsNew({{{ $user->id }}})"></i> @endif
        ...
        <div class="right-cross-alpha" style="background-image:url('@theme_asset('images/background_bg.png')');background-size:cover">
            <img ng-mousedown="dislikeyou()" id="close-button" src="@theme_asset('images/close.png')">
                ...
                @else
                    <img id="like-button" src="@theme_asset('images/like.png')" data-toggle="tooltip" title="Recarga las balas para poder hacer wara">
                @endif
        </div>
        @endif 
