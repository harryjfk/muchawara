...
<div class="cont-cover mid_body_container">
    <div class="cont-header">
        ...
        <div class="name-c-1"> 
	        <span class="shared">{{{trans_choice('app.you_have_matches',1)}}} 4 {{{trans_choice('app.matches',1)}}}</span>
	        
	       
	       
	       
	       
	       {{{Theme::render('edit_profile_info')}}} 
    ...
    <div class="bg-wh">
        ...
        <form class="form-horizontal hidden_form" id="updt_interest_by_id">
            <div class="form-group">
                <div class="col-xs-12">
                    <input type="text" class="form-control" placeholder="{{{trans_choice('app.interest',1)}}}" name="interest" required id="add_interests">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-10">
