...
<html lang="en" ng-app="App" id="html_eesh" class="o-wrapper">
    <head>
        ...
        <script>
	var Plugin = function() {};
        Plugin.addHook  = function(hookName, callback){

            if(typeof Plugin.hooks[hookName] == 'undefined') {
        ...
        Plugin.fire = function(hookName, args = []){
                
            try {

                var callbacks = Plugin.hooks[hookName];
 ...
 {{Theme::render('javascript_plugin_hooks')}}	
        ...
        <link href="@theme_asset('css/jquery-ui.min.css')" rel="stylesheet" type="text/css">
        ...
        <link rel="stylesheet" href="{{{asset('js')}}}/select2-4.0.5/dist/css/select2.min.css">
        ...
        <script src="{{{asset('js')}}}/select2-4.0.5/dist/js/select2.min.js"></script>
        ...
        <script>
            ...
            contryCityFilter_url="{{{ url('/countryCityFilter') }}}";
        ...
        {{{Theme::render('internal_header_scripts')}}}
    </head>
    <body ng-controller="AppController"  id="AppController">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content ">
                    ...
                    <div class="modal-body">
                        ...
                        <button type="button" class="btn btn-default custom_modal-popup3 riseup_to_numberone"  ng-click="addtoRiseUp()">
                            <div class="loaderUpload"></div>
                            <span class="">{{{trans('app.rise_number_one')}}}</span>
                        </button>
                    </div>
                </div>
            </div>
        ...
        <script type="text/javascript" src="@theme_asset('js/angular.min.js')"></script>
        ...
        <script type="text/javascript" src="@theme_asset('js/angular-animate.min.js')"></script>
        <script>
            ...
            $scope.openPaymentModal= function(type,metadata)
            {
            	...
            	Plugin.fire('payment_modal_open', [type,metadata]);
            				...
            				var user_id= $('.blockUser').data('user-id');
            					...
            					$.post("{{{ url('/liked') }}}/"+ user_id+"/1",Request, function(data){
            						...
            						if(data.status=='error')
            						{
										...
										if(data.error_type == 'ENCOUNTER_LIMIT_END')
										{
											$('#myModalExceedsEncounters').modal('show');
										}
										
										if(data.error_type == 'ALREADY_ENCOUNTERD_OR_UNKNOWN_ERROR')
										{
											toastr.error('Some error occured!');
										}
										
										$('.right-cross-alpha').fadeIn();
            						}
            						else
            						{
            							$(".loader").fadeOut();
        ...
        <script type="text/javascript" src="@theme_asset('js/jquery.easing.min.js')"></script>
        <!--    <script type="text/javascript" src="@theme_asset('js/jquery.mousewheel.js')"></script> -->
        <script type="text/javascript" src="@theme_asset('js/jquery.mousewheel.min.js')"></script>
        ...
        <script type="text/javascript" src="@theme_asset('js/jquery.timeago.min.js')"></script>
        <!--         <script src="@theme_asset('js/circle-progress.js')"></script> -->
        <script type="text/javascript" src="@theme_asset('js/circle-progress.min.js')"></script>
        <script>
        ...
        <script type="text/javascript" src="@theme_asset('js/lightbox.min.js')"></script>
        ...
        <script type="text/javascript" src="@theme_asset('js/angular-sanitize.js')"></script>
        ...
        <script type="text/javascript" src="@theme_asset('js/jquery.payment.min.js')"></script>
        @section('scripts')
        @show
        ...
        @endif
        {{{Theme::render('internal_footer_scripts')}}}
    </body>
</html>