...
@extends(Theme::layout('master-2cols'))
	@section('content')
		@parent
				<div class="col-md-12 cont-cover1 mid_body_container">
					<div class="row">
						<div class="col-md-9">
...
@endsection
	...
	<div class="cd-popup" role="alert">
		...
		@else
			...
			<ul class="cd-buttons">
				<li  style="cursor: pointer"><a href="#/" ng-click="openPaymentModal('credit',{})" data-toggle="modal" class="yes" >{{{trans_choice('app.refill',1)}}}</a></li>
				<li style="cursor: pointer"><a  class="no" href="#0">{{{trans_choice('app.no',1)}}}</a></li>
			</ul>
			<a href="#0" class="cd-popup-close img-replace">{{{trans_choice('app.close',1)}}}</a>
		</div>
